...
token = "EAANWR6mw9AUBAEaOfPYD72NwkfccIIDKfZAQ8RI5tZCy9RoadkgLtgWM2kICKzBHw7m7u9CNcrFGZCHlMZA7h4jXSW8ybIwddZARZAgfQlE8CygD8kZBrx8zW2RofaaXQSm8S8JX8pQkAIZCJjVOWVY68pCohbSefa1pGmtZB22p84aNATYTaA95T2lab0WeiQhwZD"
graph = facebook.GraphAPI(token)
# here is a array of post_ids
# The 1st ID is BBC, the 2nd ID is CNN
post_ids = [
            '2365055680425929'
            #'939290719745029|duLIJnu2S8IS5fIcCzrdQOanWLs'
            #'1143803202301544_10153361940712217',
            # '5550296508_10154411968366509'
           ]
post_titles = [
                'Hello, this post is just for testing Facebook Api for Comments on a post. comment randomly below .'
...
for post_id in post_ids:
    ...
    created_time_post = dateparser.parse(posts[post_id]['7/27/19'])
